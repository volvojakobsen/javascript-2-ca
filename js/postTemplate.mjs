...
export const postTemplateUser = `<div class="card mb-3 col-10">
<div class="row g-0">
  <div class="col-md-4">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" onclick='update(${json[i].id})'>Update Post</button>
          </div>
        </div>
      </div>
    </div></div>
...
export const postTemplateNotUser = `<div class="card mb-3 col-10">
<div class="row g-0">
  <div class="col-md-4">
    <img src="${json[i].media}" class="img-fluid rounded-start" alt="profile-picture">
  </div>
